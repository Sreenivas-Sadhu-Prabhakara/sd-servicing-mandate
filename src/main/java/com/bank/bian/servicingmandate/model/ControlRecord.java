package com.bank.bian.servicingmandate.model;
...
/**
 * The BIAN control record for this service domain: "Servicing Mandate Management Plan".
 *
 ...
 * to its asset type (Servicing Mandate). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Servicing Mandate Management Plan";
